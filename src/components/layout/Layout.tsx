...
export function Layout({ children, title }: LayoutProps) {
  ...
  return (
    <div className="flex h-screen w-full bg-background overflow-hidden mobile-fixed">
      {/* Desktop Sidebar */}
      {!isMobile && <Sidebar />}
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-auto p-2 sm:p-4 md:p-6 w-full mobile-container">
